            ...
            <div key={video.id} className="relative group">
              ...
              <div className="absolute top-2 left-2 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                <Link
                  ...
                  className="p-2 bg-sky-500/90 hover:bg-sky-500 text-white rounded-lg shadow-lg border border-sky-400/50"
                  title="Editar video"
                >
                ...
                <button
                  ...
                  className="p-2 bg-red-500/90 hover:bg-red-500 text-white rounded-lg shadow-lg border border-red-400/50"
